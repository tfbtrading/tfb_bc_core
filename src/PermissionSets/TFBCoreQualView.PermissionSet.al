permissionset 50102 "TFB Core Qual - View"
{
    Assignable = true;
    Caption = 'TFB Core Quality - VIEW';
    Permissions =
    tabledata "TFB Lot Expiry Buffer" = R,

        tabledata "TFB Certification Type" = R,
        tabledata "TFB Company Certification" = R,

        tabledata "TFB Core Setup" = r,

        tabledata "TFB Lot Image" = R,

        tabledata "TFB Quality Auditor" = R,
        tabledata "TFB Reservation Strategy" = R,

        tabledata "TFB Sample Request" = R,
        tabledata "TFB Sample Request Line" = R,
        tabledata "TFB Vendor Certification" = R,
