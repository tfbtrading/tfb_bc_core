page 50121 "TFB Report Sel - Containers"
{

    ApplicationArea = Basic, Suite;
    Caption = 'Report Selection - Inbound Shipments';
    PageType = Worksheet;
    SaveValues = true;
    ...
    layout
    {
        area(content)
        {
            field(ReportUsage; ReportUsage2)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Usage';
                OptionCaption = 'Inbound Shipment - Warehouse';
    ...
    var
        ReportUsage2: Option "Inbound Shipment - Warehouse";
    ...
    begin
        ...
        case ReportUsage2 of
            ReportUsage2::"Inbound Shipment - Warehouse":
                Rec.SetRange(Usage, Rec.Usage::"P.Inbound.Shipment.Warehouse");
        ...
        if Rec.GetFilter(Usage) <> '' then begin
            if Evaluate(DummyReportSelections.Usage, Rec.GetFilter(Usage)) then
                case DummyReportSelections.Usage of
                    Rec.Usage::"P.Inbound.Shipment.Warehouse":
                        ReportUsage2 := ReportUsage2::"Inbound Shipment - Warehouse"
